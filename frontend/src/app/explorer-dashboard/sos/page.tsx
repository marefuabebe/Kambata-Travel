...
export default function ExplorerSOSPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto pb-16 pt-4">
      ...
      {/* Tabs */}
      <div className="flex gap-2 mb-8 bg-gray-100 dark:bg-[#0A0F1C] p-1.5 rounded-2xl">
        ...
        {tab === "submit" && (
          <motion.div key="submit" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="bg-white dark:bg-[#0A0F1C] rounded-[2.5rem] border border-gray-100 dark:border-white/5 shadow-xl p-8 space-y-6">
                {/* Emergency Type */}
                <div>
        ...
        {tab === "history" && (
          <motion.div key="history" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
            ...
            {loadingAlerts ? (
              ...
              <div className="bg-white dark:bg-[#0A0F1C] rounded-[2.5rem] border border-gray-100 dark:border-white/5 shadow-sm p-12 text-center">
