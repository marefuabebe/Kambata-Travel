...
export default function BookingDetailsPage() {
  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-12 gap-8 mt-8 items-stretch">
        
        {/* ── Row 1 (Left, 8 cols): Booking Timeline ── */}
        <div className="lg:col-span-8 bg-white dark:bg-[#1E293B] backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-white/5 p-8 shadow-sm h-full flex flex-col justify-between">
          <div>
            ...
            <div className="relative border-l-2 border-emerald-500/20 ml-4 space-y-7 pb-2">
        ...
        {/* ── Row 1 (Right, 4 cols): Unified Payment & Documents Card (Equal Height to Timeline) ── */}
        <div className="lg:col-span-4 bg-white dark:bg-[#1E293B] backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-white/5 p-8 shadow-sm h-full flex flex-col justify-between space-y-6">
        ...
        {/* ── Row 2 (Left, 8 cols): Guide Profile Card or Package Coordinator ── */}
        <div className="lg:col-span-8 bg-white dark:bg-[#1E293B] backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-white/5 p-8 shadow-sm h-full flex flex-col justify-center">
        ...
        {/* ── Row 2 (Right, 4 cols): Help & Support ── */}
        <div className="lg:col-span-4 bg-gradient-to-br from-[#FF8C00] to-orange-500 rounded-[2.5rem] p-8 text-white shadow-xl relative overflow-hidden h-full flex flex-col justify-between">
