  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-12 pt-8 lg:pt-10 px-4 sm:px-0">
      ...
      <motion.div 
        ...
        className="flex bg-white dark:bg-[#0A0F1C] rounded-xl p-1 mb-8 w-max border border-gray-200 dark:border-white/10 shadow-sm relative z-[10]"
      >
...
function BookingCard({
  ...
  return (
    <li className="bg-white dark:bg-[#0A0F1C] backdrop-blur-xl rounded-3xl border border-gray-100 dark:border-white/5 p-3 flex flex-col sm:flex-row shadow-sm hover:shadow-xl dark:shadow-none hover:bg-gray-50/50 dark:hover:bg-white/5 transition-all group overflow-hidden relative">
  ...
  return (
    ...
    >
      <div className="flex min-h-full items-start justify-center p-4 pt-24 pb-32 md:pb-12">
        ...
        {/* Main Card */}
        <div ref={passRef} className={`rounded-[2rem] shadow-2xl overflow-hidden relative border border-white/20 ${isCompleted ? 'bg-[#0f172a]' : 'bg-white dark:bg-[#0A0F1C]'}`}>
          ...
          {isCompleted ? (
            ...
            <div className={`p-5 text-center ${isCheckedIn ? 'bg-gradient-to-br from-emerald-500 to-teal-600' : 'bg-gradient-to-br from-[#1A331B] to-[#2C522D]'} relative overflow-hidden`}>
              ...
              {/* Ticket Notches Top */}
              <div className="absolute -bottom-4 -left-4 w-8 h-8 bg-white dark:bg-[#0A0F1C] rounded-full shadow-inner z-10" />
              <div className="absolute -bottom-4 -right-4 w-8 h-8 bg-white dark:bg-[#0A0F1C] rounded-full shadow-inner z-10" />
            </div>
          )}
        ...
        {qrData && !loading && (
          <div className="mt-4 flex flex-col sm:flex-row gap-3">
            <button 
              ...
              className="flex-1 bg-white dark:bg-[#0A0F1C] border border-gray-100 dark:border-white/10 text-gray-900 dark:text-white p-4 rounded-xl font-black text-sm flex items-center justify-center gap-2 hover:bg-gray-50 dark:hover:bg-white/5 transition-all shadow-xl hover:-translate-y-1 disabled:opacity-50"
            >
