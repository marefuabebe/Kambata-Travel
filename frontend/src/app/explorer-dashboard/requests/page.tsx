...
export default function MyRequestsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto pb-12 space-y-8">
      ...
      {requests.length === 0 ? (
        <div className="bg-white dark:bg-[#1E293B] backdrop-blur-xl border border-gray-100 dark:border-white/5 rounded-[2.5rem] p-16 text-center shadow-sm">
        ...
        <div className="grid gap-6">
          {requests.map(req => {
            ...
            return (
              <div key={req._id} className="bg-white dark:bg-[#1E293B] backdrop-blur-xl border border-gray-100 dark:border-white/5 rounded-3xl p-6 shadow-sm flex flex-col md:flex-row gap-6 items-center">
