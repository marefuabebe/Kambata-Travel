...
function StatCard({ label, value, color, icon }: { label: string; value: number; color: string; icon: React.ReactNode }) {
  return (
    <div className={`bg-white dark:bg-[#1E293B] rounded-3xl border ${color} p-6 shadow-sm`}>
...
function AlertCard({ alert, onUpdate }: { alert: any; onUpdate: () => void }) {
  ...
  return (
    <motion.div
      layout
      className={`bg-white dark:bg-[#1E293B] rounded-[2rem] border shadow-sm overflow-hidden transition-all ${
  ...
  return (
    <div className="max-w-5xl mx-auto pb-16">
      ...
      <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
        ...
        <button onClick={fetchData} className="w-11 h-11 rounded-2xl bg-white dark:bg-[#1E293B] border border-gray-100 dark:border-white/10 flex items-center justify-center text-gray-500 hover:text-[#1A331B] dark:hover:text-emerald-400 shadow-sm transition-colors">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white dark:bg-[#1E293B] rounded-3xl border border-red-100 dark:border-red-500/20 p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-3">
        ...
        <div className="bg-white dark:bg-[#1E293B] rounded-3xl border border-indigo-100 dark:border-indigo-500/20 p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-3">
        ...
        <div className="bg-white dark:bg-[#1E293B] rounded-3xl border border-emerald-100 dark:border-emerald-500/20 p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-3">
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        {[
          ...
          <select
            ...
            className="bg-white dark:bg-[#1E293B] border border-gray-200 dark:border-white/10 rounded-2xl px-4 py-2.5 text-sm font-bold text-gray-700 dark:text-gray-300 focus:outline-none focus:border-[#1A331B] dark:focus:border-emerald-500 transition-colors cursor-pointer"
          >
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-[#1E293B] rounded-[2.5rem] border border-gray-100 dark:border-white/5 shadow-sm p-16 text-center">
