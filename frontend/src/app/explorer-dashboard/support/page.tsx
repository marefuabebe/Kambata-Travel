    ...
    <div className="max-w-6xl mx-auto space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mt-8">
        ...
        <div className="col-span-1 lg:col-span-6 space-y-8 h-full">
          ...
          <div className="bg-white dark:bg-[#1E293B]/60 backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-white/5 p-8 shadow-sm flex flex-col h-full">
