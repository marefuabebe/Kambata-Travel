  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-12 mt-4 lg:mt-0">
      ...
      <motion.div 
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.2 }}
        className="flex items-center gap-2 bg-white dark:bg-[#0A0F1C] backdrop-blur-xl p-2 rounded-2xl border border-gray-100 dark:border-white/5 w-fit shadow-sm"
      >
        {["all", "unread"].map(t => (
          <button
            key={t}
        ...
        <AnimatePresence mode="popLayout">
          {filtered.length === 0 ? (
            <motion.div 
              ...
              className="py-24 text-center bg-white dark:bg-[#0A0F1C] backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-white/5 shadow-sm"
            >
            ...
            filtered.map((n, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`relative bg-white dark:bg-[#0A0F1C] backdrop-blur-xl p-6 rounded-3xl border transition-all hover:shadow-lg group flex gap-6 cursor-pointer overflow-hidden ${
