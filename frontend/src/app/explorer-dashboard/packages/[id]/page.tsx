    ...
    >
      ...
      <div className="grid lg:grid-cols-12 gap-10 mt-12">
        <div className="lg:col-span-8 space-y-10">
          ...
          <section>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 <div className="flex items-start gap-4 p-6 bg-white dark:bg-[#161B26]/60 backdrop-blur-xl rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
          ...
          <section>
            ...
            <div className="bg-white dark:bg-[#161B26]/60 backdrop-blur-xl p-6 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="bg-white dark:bg-[#161B26]/60 backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-white/5 p-8 shadow-sm sticky top-8">
