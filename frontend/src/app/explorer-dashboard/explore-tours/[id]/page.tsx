      ...
      <div className="grid lg:grid-cols-12 gap-10 mt-12">
          ...
          <section>
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
               {[
                 ...
                 <div key={i} className="flex flex-col items-center justify-center text-center p-6 bg-white dark:bg-[#1E293B]/60 backdrop-blur-xl rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
          ...
          <section>
            ...
            <div className="grid gap-6">
               {reviews.length > 0 ? reviews.map((r: any) => (
                 <div key={r._id} className="bg-white dark:bg-[#1E293B]/60 backdrop-blur-xl p-6 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
        ...
        <div className="lg:col-span-4">
          ...
          {canInstantBook && tour.schedules?.length > 0 ? (
            ...
            <div className="bg-white dark:bg-[#1E293B]/60 backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-white/5 p-8 shadow-sm text-center relative overflow-hidden">
