  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-12">
      ...
      <motion.div 
        ...
        className="bg-white dark:bg-[#0A0F1C] backdrop-blur-xl rounded-[1.5rem] md:rounded-[2rem] border border-gray-100 dark:border-white/5 p-4 md:p-4 flex flex-col md:flex-row gap-4 md:items-center shadow-sm"
      >
