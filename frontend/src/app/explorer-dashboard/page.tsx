  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="relative overflow-hidden rounded-[2.5rem] bg-[#0A0F1C] dark:bg-[#0A0F1C] border border-white/10 p-8 md:p-12 shadow-2xl mt-8"
      >
      ...
      <div className="bg-white dark:bg-[#0A0F1C] backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-white/5 shadow-sm h-[320px] flex flex-col relative overflow-hidden group">
      ...
      <div className="grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          {data?.nextTour ? (() => {
            ...
            <motion.div 
              className="bg-gray-50 dark:bg-[#0A0F1C] rounded-[2.5rem] p-12 text-center border border-dashed border-gray-200 dark:border-white/10"
            >
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="bg-white dark:bg-[#0A0F1C] backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-white/5 p-8 shadow-sm relative overflow-hidden">
      ...
      <div className="px-4 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            { label: t("explorerDashboard.stats.points"), value: 450, icon: Star, color: "text-amber-500" } // Mock points
             ...
             <div key={i} className="bg-white dark:bg-[#0A0F1C] p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-white/5 flex flex-col justify-between h-28">
        ...
        <div>
          ...
          {data?.nextTour ? (() => {
            ...
            return (
              <motion.div whileHover={{ scale: 0.98 }} className="bg-white dark:bg-[#0A0F1C] rounded-3xl overflow-hidden shadow-sm border border-gray-100 dark:border-white/5 relative">
            ...
            <div className="bg-white dark:bg-[#0A0F1C] rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-white/5 text-center">
        ...
        <div>
          ...
          <div className="flex overflow-x-auto gap-4 pb-4 -mx-4 px-4 custom-scrollbar hide-scrollbar snap-x">
             {recommendations.slice(0, 4).map((rec: any, idx) => {
                ...
                return (
                  <div key={idx} onClick={() => router.push(`/explorer-dashboard/explore-tours?tour=${rec._id}`)} className="snap-start shrink-0 w-64 bg-white dark:bg-[#0A0F1C] rounded-3xl overflow-hidden shadow-sm border border-gray-100 dark:border-white/5 relative">
        ...
        <div>
          ...
          <div className="grid grid-cols-4 gap-3 bg-white dark:bg-[#0A0F1C] rounded-[2rem] p-6 shadow-sm border border-gray-100 dark:border-white/5">
            {[
