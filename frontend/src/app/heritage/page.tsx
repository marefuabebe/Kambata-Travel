      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroBg} style={{ position: 'absolute', inset: 0, overflow: 'hidden' }}>
            <img src="https://res.cloudinary.com/dzf4st3t2/image/upload/v1781979624/Gemini_Generated_Image_pjkk9epjkk9epjkk_sr3fna.png" alt="Kambata Culture" loading="lazy" decoding="async" className="w-full h-full object-cover" />
          </div>
