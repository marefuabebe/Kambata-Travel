      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroBg} style={{ position: 'absolute', inset: 0, overflow: 'hidden' }}>
            <img src={"https://res.cloudinary.com/dzf4st3t2/image/upload/v1785582594/d287e0e2-8faa-44bf-a16b-b1665fc1f1ef_tcggcu.png".replace('/upload/', '/upload/f_auto,q_auto,w_1920/')} alt="Hero Background" loading="eager" fetchPriority="high" decoding="async" className="w-full h-full object-cover" />
          </div>
