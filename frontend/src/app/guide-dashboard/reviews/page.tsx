      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 bg-white dark:bg-[#1E293B] rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-white/5 grid grid-cols-2 gap-x-8 gap-y-6">
              ...
              <div className="grid gap-6">
                {reviews.map((review, i) => (
                  <motion.div 
                    ...
                    className="bg-white dark:bg-[#1E293B] rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-white/5"
                  >
