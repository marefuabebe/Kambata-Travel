              ...
              <AnimatePresence>
                {list.map((i, idx) => (
                  <motion.div 
                    ...
                    key={i._id} 
                    className="bg-white dark:bg-[#1E293B] backdrop-blur-xl rounded-[2rem] border border-gray-100 dark:border-white/5 p-6 shadow-sm hover:shadow-md transition-shadow group"
                  >
