        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            {data?.upcomingSchedule ? (
              ...
              <div className="bg-white dark:bg-[#0A0F1C] backdrop-blur-xl rounded-[3rem] border border-dashed border-gray-200 dark:border-white/10 p-16 text-center h-full flex flex-col items-center justify-center">
          ...
          >
            ...
            <Link href="/guide-dashboard/assigned-tours" className="flex items-center gap-4 p-4 bg-white dark:bg-[#0A0F1C] backdrop-blur-xl border border-gray-100 dark:border-white/5 rounded-[1.5rem] hover:shadow-lg hover:-translate-y-1 transition-all group cursor-pointer">
            ...
            <Link href="/guide-dashboard/attendance" className="flex items-center gap-4 p-4 bg-white dark:bg-[#0A0F1C] backdrop-blur-xl border border-gray-100 dark:border-white/5 rounded-[1.5rem] hover:shadow-lg hover:-translate-y-1 transition-all group cursor-pointer">
            ...
            <Link href="/guide-dashboard/incidents" className="flex items-center gap-4 p-4 bg-white dark:bg-[#0A0F1C] backdrop-blur-xl border border-gray-100 dark:border-white/5 rounded-[1.5rem] hover:shadow-lg hover:-translate-y-1 transition-all group cursor-pointer">
      ...
      <div className="lg:hidden font-sans pb-10">
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="show" className="space-y-6 px-4">
          ...
          <div className="grid grid-cols-2 gap-4">
             <motion.div variants={itemVariants} className="bg-white dark:bg-[#0A0F1C] rounded-[20px] p-4 shadow-sm border border-gray-100 dark:border-white/5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <motion.div variants={itemVariants} className="bg-white dark:bg-[#0A0F1C] rounded-[20px] p-4 shadow-sm border border-gray-100 dark:border-white/5 hover:-translate-y-1 transition-transform">
          ...
          <motion.div variants={itemVariants}>
            ...
            {data?.upcomingSchedule ? (
              <div className="bg-white dark:bg-[#0F172A] rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none border border-gray-100 dark:border-slate-800 overflow-hidden relative group">
                 ...
                 <div className="p-5">
                    {/* Live Progress */}
                    <div className="bg-slate-50 dark:bg-[#0A0F1C] rounded-2xl p-4 mb-5 border border-slate-100 dark:border-slate-800">
                    ...
                    <div className="flex justify-between items-center bg-white dark:bg-slate-900 rounded-2xl p-4 border border-slate-100 dark:border-slate-800 shadow-sm mb-5">
                      ...
                      <div className="flex -space-x-2">
                        ...
                        <div className="w-9 h-9 rounded-full bg-slate-100 dark:bg-[#0A0F1C] border-2 border-white dark:border-slate-900 flex justify-center items-center text-[10px] font-black text-slate-600 dark:text-slate-300 shadow-sm">+10</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-amber-50 dark:bg-amber-900/10 rounded-2xl border border-amber-100 dark:border-amber-900/20 mb-5">
                       ...
                       <button className="w-12 h-12 bg-white dark:bg-[#0A0F1C] rounded-full flex items-center justify-center shadow-md text-amber-600 dark:text-amber-500 hover:scale-105 active:scale-95 transition-all">
                 ...
                 <div className="px-5 pb-5 flex gap-3">
                    <Link href={`/guide-dashboard/assigned-tours/${data.upcomingSchedule.tourId}/${data.upcomingSchedule.scheduleId}`} className="flex-1 bg-white dark:bg-[#0A0F1C] border-2 border-slate-100 dark:border-slate-700 hover:border-slate-200 dark:hover:border-slate-600 text-slate-700 dark:text-slate-200 py-3.5 rounded-xl text-sm font-black text-center active:scale-95 transition-all">
          ...
          {data?.upcomingSchedule && (
            <motion.div variants={itemVariants}>
               ...
               <div className="bg-white dark:bg-[#0A0F1C] rounded-[20px] p-5 shadow-sm border border-gray-100 dark:border-white/5">
                  <div className="relative pl-6 border-l-2 border-gray-100 dark:border-white/10 space-y-6">
                     <div className="relative">
                        <div className="absolute -left-[31px] bg-white dark:bg-[#0A0F1C] p-1"><div className="w-3 h-3 rounded-full bg-[#16A34A]"></div></div>
                     ...
                     <div className="relative">
                        <div className="absolute -left-[31px] bg-white dark:bg-[#0A0F1C] p-1"><div className="w-3 h-3 rounded-full bg-[#0EA5E9]"></div></div>
                     ...
                     <div className="relative">
                        <div className="absolute -left-[31px] bg-white dark:bg-[#0A0F1C] p-1"><div className="w-3 h-3 rounded-full border-2 border-gray-300 dark:border-gray-600"></div></div>
