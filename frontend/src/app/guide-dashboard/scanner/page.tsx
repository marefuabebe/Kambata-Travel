    ...
    <div className="max-w-2xl mx-auto pb-16 relative">
        ...
        {showOverrideModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            <motion.div
              ...
              className="bg-white dark:bg-[#1E293B] rounded-3xl shadow-2xl p-8 max-w-sm w-full text-center border border-amber-200 dark:border-amber-500/30"
            >
        ...
        {showPinModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.9 }}
              className="bg-white dark:bg-[#1E293B] rounded-3xl shadow-2xl p-8 max-w-sm w-full text-center border border-gray-100 dark:border-white/10"
            >
      ...
      <div className="flex items-center gap-4 mb-10">
        <Link
          ...
          className="w-11 h-11 rounded-2xl bg-white dark:bg-[#1E293B] border border-gray-100 dark:border-white/10 flex items-center justify-center text-gray-500 hover:text-[#1A331B] dark:hover:text-emerald-400 shadow-sm transition-colors"
        >
          <ChevronLeft size={20} />
        </Link>
        <div>
      ...
      <AnimatePresence mode="wait">
        ...
        {scanState === "idle" && (
          <motion.div
            ...
            className="bg-white dark:bg-[#1E293B] rounded-[2.5rem] border border-gray-100 dark:border-white/5 shadow-xl p-12 text-center"
          >
        ...
        {scanState === "scanning" && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="bg-white dark:bg-[#1E293B] rounded-[2.5rem] border border-gray-100 dark:border-white/5 shadow-xl overflow-hidden"
          >
            ...
            <div className="p-4">
              <div
                id={scannerDivId}
                className="[&_video]:rounded-[1.5rem] [&_img]:rounded-[1.5rem] [&_select]:bg-white [&_select]:dark:bg-[#1E293B] [&_select]:text-gray-900 [&_select]:dark:text-white [&_select]:rounded-xl [&_select]:border [&_select]:border-gray-200 [&_select]:dark:border-white/10 [&_select]:px-3 [&_select]:py-2 [&_select]:text-sm"
              />
            </div>
        ...
        {scanState === "duplicate" && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            transition={{ type: "spring", stiffness: 200, damping: 20 }}
            className="bg-white dark:bg-[#1E293B] rounded-[2.5rem] border border-amber-200 dark:border-amber-500/30 shadow-2xl shadow-amber-500/10 overflow-hidden"
          >
        ...
        {scanState === "error" && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            transition={{ type: "spring", stiffness: 200, damping: 20 }}
            className="bg-white dark:bg-[#1E293B] rounded-[2.5rem] border border-red-200 dark:border-red-500/30 shadow-2xl shadow-red-500/10 overflow-hidden"
          >
            ...
            {showManual ? (
              <form onSubmit={handleManualSubmit} className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 bg-white dark:bg-[#1E293B] border border-gray-200 dark:border-white/10 rounded-xl px-4 py-2.5 text-sm font-mono uppercase focus:ring-2 focus:ring-[#1A331B] dark:focus:ring-emerald-500 outline-none"
                />
                <button
                  type="submit"
              ...
              <button
                ...
                className="inline-flex items-center gap-2 text-sm font-bold text-[#1A331B] dark:text-emerald-400 hover:opacity-80 transition-opacity bg-white dark:bg-[#1E293B] border border-gray-200 dark:border-white/10 rounded-xl px-4 py-2 shadow-sm"
              >
