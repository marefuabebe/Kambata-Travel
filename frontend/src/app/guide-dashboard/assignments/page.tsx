          ...
          <AnimatePresence>
            {filtered.map((a, idx) => (
              <motion.div
                ...
                className="bg-white dark:bg-[#0A0F1C] backdrop-blur-xl rounded-[2rem] border border-gray-100 dark:border-white/5 overflow-hidden shadow-sm flex flex-col"
              >
                {/* Image Header */}
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100 dark:border-white/5 flex gap-3">
                    ...
                    {activeTab === "accepted" && (
                      <Link
                        ...
                        className="w-full py-3 flex justify-center items-center gap-2 rounded-xl bg-[#1A331B] dark:bg-[#0A0F1C] text-white font-bold hover:opacity-90 transition-opacity"
                      >
