            ...
            <AnimatePresence>
              {filtered.map((r, idx) => (
                ...
                >
                  ...
                  {/* Content Card */}
                  <div className="flex-1 bg-white dark:bg-[#1E293B] backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-white/5 p-6 md:p-8 shadow-sm hover:shadow-xl dark:shadow-none hover:bg-gray-50 dark:hover:bg-[#1E293B] transition-all relative overflow-hidden">
