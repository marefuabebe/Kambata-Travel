  ...
  return (
    <div className="max-w-4xl mx-auto pb-12">
      ...
      <motion.div 
        ...
        className="flex flex-wrap gap-4 mb-10 items-center bg-white dark:bg-[#0A0F1C] backdrop-blur-xl p-4 rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm"
      >
            ...
            <AnimatePresence>
              {filtered.map((r, idx) => (
                ...
                >
                  ...
                  {/* Content Card */}
                  <div className="flex-1 bg-white dark:bg-[#0A0F1C] backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-white/5 p-6 md:p-8 shadow-sm hover:shadow-xl dark:shadow-none hover:bg-gray-50 dark:hover:bg-[#0A0F1C] transition-all relative overflow-hidden">
