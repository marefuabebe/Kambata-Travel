    ...
    >
      ...
      <div className="relative space-y-8 before:absolute before:inset-0 before:ml-[1.375rem] before:-translate-x-px sm:before:ml-[2.375rem] before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gray-200 dark:before:via-gray-800 before:to-transparent">
         {notifications.length === 0 ? (
           <div className="relative z-10 bg-white dark:bg-[#0A0F1C] backdrop-blur-xl border border-gray-100 dark:border-white/5 rounded-[2.5rem] p-16 text-center shadow-sm ml-12 sm:ml-20">
            ...
            notifications.map((notif, index) => (
              ...
              >
                 ...
                 <div className={`flex-1 bg-white dark:bg-[#0A0F1C] backdrop-blur-xl rounded-[20px] sm:rounded-[2rem] p-5 sm:p-6 border transition-all group-hover:-translate-y-1 group-hover:shadow-lg ${
                  !notif.isRead 
