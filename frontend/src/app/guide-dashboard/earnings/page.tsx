...
export default function EarningsRestricted() {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-[#1E293B] backdrop-blur-xl border border-gray-100 dark:border-white/5 rounded-[2.5rem] p-12 md:p-16 text-center shadow-sm relative overflow-hidden">
