...
export default function MobileCalendarView({ events, loading, onBlockDatesClick }: MobileCalendarViewProps) {
  ...
  if (loading) {
    return (
      <div className="lg:hidden flex flex-col gap-6 relative min-h-screen pb-24 px-2">
        {/* Calendar Skeleton */}
        <div className="bg-white dark:bg-[#0A0F1C] rounded-[20px] p-4 shadow-sm border border-gray-100 dark:border-white/5 animate-pulse">
  ...
  return (
    <div className="lg:hidden flex flex-col gap-6 relative min-h-[100vh] pb-24 pt-2">
      ...
      {/* 1. Mini Calendar */}
      <div className="bg-white dark:bg-[#0A0F1C] rounded-[20px] p-4 shadow-[0_2px_10px_rgba(0,0,0,0.03)] dark:shadow-none border border-gray-100 dark:border-white/5 mx-2">
      ...
      <motion.div 
        ...
        className="bg-white dark:bg-[#0A0F1C] border border-gray-100 dark:border-white/5 rounded-[20px] p-4 flex items-center justify-between shadow-sm mx-2"
      >
      ...
      <div className="px-2">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3">
          <div className="bg-white dark:bg-[#0A0F1C] border border-gray-100 dark:border-white/5 rounded-[1.25rem] p-3 shadow-sm flex flex-col items-center justify-center text-center hover:-translate-y-1 transition-transform">
          ...
          <AnimatePresence mode="popLayout">
            {todaysEvents.length === 0 ? (
              <motion.div 
                ...
                className="bg-white dark:bg-[#0A0F1C] border border-gray-100 dark:border-white/5 rounded-[20px] p-10 text-center flex flex-col items-center gap-4 shadow-sm"
              >
              ...
              todaysEvents.map((ev, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`bg-white dark:bg-[#0A0F1C] rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.2)] border border-gray-100 dark:border-white/5 overflow-hidden transition-all hover:-translate-y-1 active:scale-[0.98] ${ev.type !== "timeOff" ? "cursor-pointer" : ""}`}
                  >
                    {ev.type !== "timeOff" && (
            ...
            >
              ...
              <div className="p-6 space-y-8">
                ...
                <div>
                  ...
                  <div className="bg-white dark:bg-[#0A0F1C] border border-gray-100 dark:border-white/5 rounded-[20px] p-5 flex items-center justify-between shadow-sm">
                    <div className="flex items-center gap-4">
      ...
      <div className="fixed bottom-24 right-6 z-50 lg:hidden">
        <AnimatePresence>
          {fabOpen && (
            ...
            >
              <button onClick={() => { setFabOpen(false); toast.error("SOS Triggered"); }} className="flex items-center gap-3 bg-white dark:bg-[#0A0F1C] shadow-xl p-2 rounded-full border border-gray-100 dark:border-white/10 group">
              ...
              <button onClick={() => { setFabOpen(false); onBlockDatesClick(); }} className="flex items-center gap-3 bg-white dark:bg-[#0A0F1C] shadow-xl p-2 rounded-full border border-gray-100 dark:border-white/10 group">
