          ...
          <AnimatePresence>
            {filteredRequests.map((req, idx) => (
              <motion.div 
                ...
                className="bg-white dark:bg-[#1E293B] backdrop-blur-xl border border-gray-100 dark:border-white/10 rounded-[2rem] p-6 shadow-sm overflow-hidden flex flex-col"
              >
