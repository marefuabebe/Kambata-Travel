    ...
    >
      <div className="mb-10 flex items-center gap-4">
        <Link 
          ...
          className="w-12 h-12 rounded-2xl bg-white dark:bg-[#1E293B] border border-gray-200 dark:border-white/10 flex items-center justify-center text-gray-500 hover:bg-gray-50 dark:hover:bg-white/5 transition-all shadow-sm"
        >
          <ArrowLeft size={20} />
        </Link>
        <div>
      ...
      <div className="bg-white dark:bg-[#1E293B] backdrop-blur-xl border border-gray-100 dark:border-white/5 rounded-[2.5rem] p-8 md:p-12 shadow-sm relative overflow-hidden">
