    ...
    <div className="max-w-7xl mx-auto pb-12">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <PageHeader
          ...
          action={
            <div className="flex items-center gap-2 bg-white dark:bg-[#0A0F1C] backdrop-blur-xl rounded-2xl px-4 py-2.5 border border-gray-100 dark:border-white/5 focus-within:border-[#145A41] dark:focus-within:border-[#10B981] transition-colors shadow-sm">
      ...
      {rows.length === 0 ? (
        ...
        <motion.div 
          ...
          className="bg-white dark:bg-[#0A0F1C] backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-white/5 overflow-hidden shadow-sm"
        >
          <>
            {/* Desktop Table View */}
              ...
              <AnimatePresence>
                {rows.map((r, idx) => (
                  <motion.div
                    ...
                    transition={{ delay: idx * 0.05 }}
                    className="bg-white dark:bg-[#0A0F1C] p-4 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm flex flex-col gap-4"
                  >
