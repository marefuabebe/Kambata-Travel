  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-6 space-y-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        ...
        <div className="bg-gray-50 dark:bg-[#0A0F1C] border border-gray-200 dark:border-white/5 rounded-3xl p-4 md:p-6 flex flex-col justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white dark:bg-[#0A0F1C] border border-gray-100 dark:border-white/5 rounded-3xl p-6 md:p-8 shadow-sm">
        ...
        <div className="bg-white dark:bg-[#0A0F1C] border border-gray-100 dark:border-white/5 rounded-3xl p-6 md:p-8 shadow-sm flex flex-col">
