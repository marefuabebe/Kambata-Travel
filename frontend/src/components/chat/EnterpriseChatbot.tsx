...
export default function EnterpriseChatbot() {
  ...
  const markdownComponents = {
    ...
    li: ({ ...props }) => (
      <li {...props} className="bg-white/70 dark:bg-[#1E293B]/70 backdrop-blur-xl border border-gray-200/60 dark:border-slate-700/60 p-5 rounded-2xl shadow-sm hover:shadow-lg transition-all m-0 flex flex-col gap-2 relative overflow-hidden" />
    ),
    strong: ({ ...props }) => (
          ...
          <>
            ...
            <div className={`w-1/5 min-w-[240px] max-w-[280px] bg-[#0F172A] text-slate-300 flex-col border-r border-slate-800 shrink-0 hidden md:flex`}>
              ...
              <div className="p-5 border-t border-slate-800/50 bg-[#0F172A]">
                <div className="flex items-center gap-3 p-3 rounded-xl bg-[#1E293B]/50 hover:bg-[#1E293B] cursor-pointer transition-all mb-5 border border-slate-800/50 hover:shadow-md">
              ...
              <div className="flex-1 overflow-y-auto p-4 sm:p-8 space-y-8 scroll-smooth custom-scrollbar">
                      ...
                      <div className="relative z-10 w-full px-5 sm:px-12 flex flex-col md:flex-row justify-between items-center gap-8 sm:gap-8">
                        ...
                        <div className="grid grid-cols-3 sm:grid-cols-3 gap-2 sm:gap-3 w-full md:w-1/2 mx-auto md:max-w-none pb-2">
                          {[
                            ...
                            <button key={i} className="bg-[#1E293B]/70 hover:bg-[#1E293B]/90 backdrop-blur-md border border-slate-500/50 rounded-xl p-1.5 sm:p-3 flex flex-col items-center justify-center gap-1 sm:gap-1.5 transition-all hover:scale-[1.03] hover:border-[#2DD4BF]/50 group text-center min-h-[3.5rem] sm:min-h-[5.5rem]">
                  ...
                  >
                    ...
                    <div className={`max-w-[85%] sm:max-w-[80%] rounded-3xl px-6 py-5 text-[15px] leading-relaxed shadow-sm ${
                      msg.role === "user" 
                        ...
                        : "bg-white/80 dark:bg-[#1E293B]/80 backdrop-blur-xl border border-gray-200/80 dark:border-slate-700/80 text-gray-800 dark:text-gray-100 rounded-tl-sm shadow-xl shadow-slate-200/20 dark:shadow-none"
                    }`}>
                      {msg.role === "model" ? (
                ...
                {isLoading && (
                  ...
                  >
                    ...
                    <div className="bg-white/80 dark:bg-[#1E293B]/80 backdrop-blur-xl border border-gray-200/80 dark:border-slate-700/80 rounded-3xl rounded-tl-sm px-6 py-5 shadow-xl min-w-[240px]">
              ...
              <div className="shrink-0 w-full bg-[#F8FAFC] dark:bg-[#0B1120] pt-2 pb-6 px-4 sm:px-6 z-20">
                ...
                <div className="relative max-w-4xl mx-auto">
                  <form 
                    ...
                    className="relative flex items-center bg-white dark:bg-[#1E293B] border border-gray-200 dark:border-slate-700 rounded-2xl p-1.5 transition-all shadow-xl shadow-slate-200/50 dark:shadow-none focus-within:shadow-[0_8px_30px_rgb(15,118,110,0.15)] focus-within:border-[#0F766E] focus-within:ring-1 focus-within:ring-[#0F766E]"
                  >
