...
export default function RequestFunnelAnalytics() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Controls */}
      <div className="flex justify-between items-center bg-white dark:bg-[#1E293B] p-4 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-[#1E293B] rounded-[1.5rem] border border-gray-100 dark:border-white/5 p-5 shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Funnel Visualizer */}
        <div className="lg:col-span-2 bg-white dark:bg-[#1E293B] rounded-[2rem] border border-gray-100 dark:border-white/5 p-6 shadow-sm">
        ...
        <div className="bg-white dark:bg-[#1E293B] rounded-[2rem] border border-gray-100 dark:border-white/5 p-6 shadow-sm">
