...
export default function AdminChatInterface() {
  ...
  return (
    <>
      <div className="flex h-[calc(100vh-10rem)] bg-white dark:bg-[#0A0F1C] rounded-[2rem] overflow-hidden shadow-sm border border-gray-200 dark:border-slate-700">
        ...
        <div className={`${activeRoom ? 'hidden md:flex' : 'flex'} flex-col w-full md:w-96 border-r border-gray-100 dark:border-slate-700 bg-gray-50 dark:bg-slate-900 z-10`}>
          <div className="p-6 border-b border-gray-100 dark:border-slate-700 flex flex-col gap-5 bg-white dark:bg-[#0A0F1C]">
        ...
        <div className={`${activeRoom ? 'flex' : 'hidden md:flex'} flex-1 flex-col relative z-10 bg-white dark:bg-slate-900`}>
          {activeRoom ? (
            <>
              {/* Header */}
              <div className="h-[88px] shrink-0 border-b border-gray-100 dark:border-slate-700 px-6 flex items-center justify-between bg-white dark:bg-[#0A0F1C]">
              ...
              <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6 custom-scrollbar bg-gray-50 dark:bg-slate-900">
                {loadingMessages ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-center p-8 text-gray-500 dark:text-gray-400">
                    <div className="w-20 h-20 bg-white dark:bg-[#0A0F1C] border border-gray-200 dark:border-slate-700 shadow-sm rounded-full flex items-center justify-center mb-6">
                        ...
                        <div className={`flex flex-col ${isMe ? 'items-end' : 'items-start'}`}>
                          ...
                          <div className={`flex ${isMe ? 'flex-row-reverse' : 'flex-row'} items-center gap-2`}>
                            ...
                            <div className={`px-5 py-3.5 rounded-2xl text-sm font-medium shadow-sm flex flex-col gap-2 relative ${
                                ...
                                : 'bg-white dark:bg-[#0A0F1C] text-gray-900 dark:text-gray-100 rounded-bl-sm border border-gray-100 dark:border-slate-700'
                            }`}>
                              {msg.isForwarded && (
              ...
              {/* Input Area */}
              <div className="p-6 bg-white dark:bg-[#0A0F1C] border-t border-gray-100 dark:border-slate-700 shrink-0 flex flex-col gap-3">
                ...
                <form onSubmit={handleSend} className={`flex items-center gap-3 bg-gray-50 dark:bg-slate-900 rounded-[1.5rem] p-2 pr-2 border ${isRecording ? 'border-red-500/50 ring-2 ring-red-500/20' : 'border-gray-200 dark:border-slate-700 focus-within:ring-2 focus-within:ring-blue-500/50'} transition-all shadow-sm relative`}>
                  <div className="flex gap-2 items-center ml-2">
                    <div className="w-8 h-8 rounded-full bg-white dark:bg-[#0A0F1C] flex items-center justify-center text-gray-400 dark:text-gray-500 shadow-sm shrink-0 border border-gray-200 dark:border-white/5">
                      <ShieldAlert size={14} />
                    </div>
                    <input
                      type="file"
                    ...
                    <button
                      ...
                      className="w-8 h-8 rounded-full bg-gray-200 dark:bg-[#0A0F1C] flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-gray-300 dark:hover:bg-white/10 transition-all border border-transparent dark:border-white/5"
                    >
                    ...
                    <button
                      ...
                      className={`w-8 h-8 rounded-full flex items-center justify-center transition-all border ${
                        isRecording 
                          ...
                          : 'bg-gray-200 dark:bg-[#0A0F1C] text-gray-600 dark:text-gray-400 hover:bg-gray-300 dark:hover:bg-white/10 border-transparent dark:border-white/5'
                      }`}
                    >
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-gray-50 dark:bg-slate-900">
              <div className="w-32 h-32 bg-white dark:bg-[#0A0F1C] rounded-full flex items-center justify-center shadow-sm border border-gray-200 dark:border-slate-700 mb-6">
      ...
      {forwardingMessage && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-[#0A0F1C] rounded-3xl w-full max-w-md overflow-hidden shadow-2xl border border-gray-200 dark:border-slate-700">
            ...
            <div className="p-4 bg-gray-50 dark:bg-slate-900 border-b border-gray-100 dark:border-slate-700">
               <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-white dark:bg-[#0A0F1C] border border-gray-200 dark:border-white/10 rounded-xl py-2 pl-9 pr-4 text-sm outline-none focus:ring-2 focus:ring-blue-500/50"
                />
               </div>
            </div>
