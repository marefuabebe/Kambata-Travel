  ...
  return (
    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
      <div>
        ...
        {subtitle && <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mt-2 max-w-xl leading-relaxed">{subtitle}</p>}
      </div>
      {action}
    </div>
  );
...
export function StatCard({
  ...
  return (
    <div className="bg-white dark:bg-[#0A0F1C] backdrop-blur-xl p-6 rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-xl dark:shadow-none hover:bg-gray-50 dark:hover:bg-white/5 transition-all group relative overflow-hidden flex items-center gap-5">
...
export function EmptyState({
  ...
  return (
    <div className="bg-white dark:bg-[#0A0F1C] backdrop-blur-xl rounded-[3rem] border border-dashed border-gray-200 dark:border-white/10 p-16 text-center shadow-sm">
