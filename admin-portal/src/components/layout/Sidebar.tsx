                ...
                <Link
                  ...
                  className={`flex items-center rounded-[12px] text-sm font-medium transition-all duration-300 relative focus:outline-none focus:ring-2 focus:ring-primary/20 ${
                    ...
                    isActive 
                      ...
                      : 'text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100/80 dark:hover:bg-[#0A0F1C] border border-transparent hover:border-gray-200 dark:hover:border-white/10'
                  }`}
                >
                  <Icon 
                    size={18} 
