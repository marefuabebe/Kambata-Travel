...
export default function AdminReviewsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 pb-12">
      ...
      {/* Tabs & Search */}
      <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center bg-white dark:bg-[#1E293B] p-2 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-[#1E293B] rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm overflow-hidden">
