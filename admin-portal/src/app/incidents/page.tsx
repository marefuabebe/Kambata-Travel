      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <button
            ...
            className="shrink-0 bg-white dark:bg-[#0A0F1C] border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white px-5 py-2.5 rounded-xl font-bold text-sm shadow-sm hover:border-gray-300 dark:hover:border-white/20 flex items-center gap-2 transition-colors"
          >
            Refresh
          </button>
        </div>
      ...
      {incidents.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
          {incidents.map((incident, idx) => (
            <div key={`${incident.scheduleId}-${idx}`} className="bg-white dark:bg-[#0A0F1C] rounded-[2rem] border border-red-100 dark:border-red-500/10 shadow-sm overflow-hidden flex flex-col group hover:shadow-md hover:border-red-200 dark:hover:border-red-500/30 transition-all relative">
