    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-16">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <button
          ...
          disabled={refreshing}
          className="flex items-center gap-2 px-5 py-3 rounded-2xl bg-white dark:bg-[#0A0F1C] border border-gray-100 dark:border-white/5 text-sm font-bold text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white shadow-sm hover:-translate-y-0.5 transition-all"
        >
      ...
      {/* ── Filters ── */}
      <div className="flex flex-wrap gap-3 p-5 bg-white dark:bg-[#0A0F1C] rounded-[1.5rem] border border-gray-100 dark:border-white/5 shadow-sm">
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-white dark:bg-[#0A0F1C] rounded-[2rem] border border-gray-100 dark:border-white/5">
