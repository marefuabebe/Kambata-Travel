      ...
      <div className="sticky top-0 z-40 bg-slate-50/90 dark:bg-[#0F172A]/90 backdrop-blur-md border-b border-slate-200 dark:border-[#334155] px-4 py-4 md:px-8 shadow-sm">
        <div className="max-w-[1400px] mx-auto space-y-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            {!loading && (
              <div className="hidden md:flex items-center gap-4 bg-white dark:bg-[#1E293B] px-4 py-2 rounded-xl border border-slate-200 dark:border-[#334155] shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1 group">
              <input 
                ...
                className="w-full bg-white dark:bg-[#1E293B] border border-slate-200 dark:border-[#334155] rounded-xl px-4 pl-10 py-3 text-sm font-bold text-slate-900 dark:text-white outline-none focus:border-[#FF8C00] focus:ring-1 focus:ring-[#FF8C00] transition-all min-h-[44px] shadow-sm"
              />
            ...
            <div className="relative min-w-[160px]">
              <select 
                ...
                className="w-full bg-white dark:bg-[#1E293B] border border-slate-200 dark:border-[#334155] rounded-xl px-4 pl-10 py-3 text-sm font-bold text-slate-900 dark:text-white outline-none focus:border-[#FF8C00] focus:ring-1 focus:ring-[#FF8C00] transition-all min-h-[44px] appearance-none shadow-sm cursor-pointer"
              >
      ...
      <div className="max-w-[1400px] mx-auto p-4 md:p-8">
        {loading ? (
          <div className="grid grid-cols-1 gap-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white dark:bg-[#1E293B] rounded-[24px] p-6 md:p-8 border border-slate-200 dark:border-[#334155] animate-pulse">
          ...
          <motion.div 
            ...
            className="relative overflow-hidden rounded-[24px] p-12 md:p-20 text-center border border-slate-200 dark:border-[#334155] bg-white dark:bg-[#1E293B] shadow-sm flex flex-col items-center justify-center mt-8"
          >
            ...
            <AnimatePresence>
              {filteredRequests.map((req, i) => (
                <motion.div
                  ...
                  className="group relative overflow-hidden bg-white dark:bg-[#1E293B] rounded-[24px] border border-slate-200 dark:border-[#334155] p-6 md:p-8 flex flex-col xl:flex-row xl:items-stretch gap-6 md:gap-8 shadow-sm hover:shadow-lg hover:border-[#FF8C00]/30 transition-all duration-300 pb-24 md:pb-8 xl:pb-8"
                >
                  {/* Decorative Glow */}
        ...
        <AnimatePresence>
          {modalState && (
            ...
            <motion.div
              ...
              className="bg-white dark:bg-[#1E293B] border border-slate-200 dark:border-[#334155] rounded-[2.5rem] p-8 md:p-10 max-w-md w-full shadow-2xl relative overflow-hidden"
            >
