    ...
    <div className="max-w-6xl mx-auto space-y-8 pb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="relative w-full md:w-80 group">
          ...
          <input
            ...
            className="w-full bg-white dark:bg-[#0A0F1C] border border-gray-200 dark:border-white/5 rounded-2xl py-3 pl-12 pr-4 text-sm font-medium text-gray-900 dark:text-white outline-none focus:border-[#FF8C00] dark:focus:border-[#FF8C00] transition-all shadow-sm"
          />
        </div>
      </div>
      ...
      <div className="md:hidden flex flex-col gap-4">
        {filteredUsers.length === 0 ? (
          <div className="p-8 text-center bg-white dark:bg-[#0A0F1C] rounded-3xl border border-gray-100 dark:border-white/5">
          ...
          filteredUsers.map((user) => (
            <div key={`mobile-${user._id}`} className="p-5 flex flex-col gap-4 bg-white dark:bg-[#0A0F1C] rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm">
      ...
      {/* Users Data View */}
      <div className="hidden md:block bg-white dark:bg-[#0A0F1C] rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-xl shadow-gray-200/40 dark:shadow-none overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto space-y-6">
              <div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div className="bg-gray-50 dark:bg-[#0A0F1C] p-3 rounded-xl border border-gray-100 dark:border-white/5 flex justify-between items-center">
