        ...
        {statCards.map((stat, idx) => (
          <Link key={stat.label} href={stat.href} className="group">
            <motion.div
              ...
              className="bg-white dark:bg-[#1E293B] p-5 md:p-6 rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm hover:shadow-md dark:shadow-none hover:border-gray-300 dark:hover:border-white/20 transition-all flex flex-col justify-between relative overflow-hidden h-full"
            >
              <div>
