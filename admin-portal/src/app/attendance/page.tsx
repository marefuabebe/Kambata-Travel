...
export default function AttendancePage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "draft":
        return <span className="px-3 py-1 bg-slate-100 text-slate-700 dark:bg-[#161B26] dark:text-slate-300 rounded-full text-[10px] font-black uppercase tracking-wider border border-slate-200 dark:border-slate-700">Draft</span>;
      case "published":
                  ...
                  >
                    ...
                    <div className="hidden md:grid grid-cols-12 gap-4 items-center">
                      ...
                      <div className="col-span-3 flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-slate-100 dark:bg-[#161B26] border-2 border-white dark:border-[#334155] shadow-sm overflow-hidden flex-shrink-0">
                      ...
                      <div className="bg-slate-50 dark:bg-[#0F172A] rounded-xl p-3 mb-4 border border-slate-100 dark:border-[#334155]">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-2">
                            <div className="w-6 h-6 rounded-full bg-slate-200 dark:bg-[#161B26] overflow-hidden flex-shrink-0">
                              {sched.guideProfilePicture ? (
                                <img src={sched.guideProfilePicture} alt={sched.guideName} className="w-full h-full object-cover" />
                              ) : (
