  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-12 text-slate-900 dark:text-slate-50">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 md:gap-4 mb-8">
        ...
        <div className="relative w-full md:w-80 sticky top-20 md:static z-20">
          <input 
            ...
            className="w-full bg-white dark:bg-[#0A0F1C] border border-slate-200 dark:border-slate-700 rounded-2xl pl-11 pr-4 py-3.5 font-medium text-sm outline-none focus:border-orange-500 dark:focus:border-orange-500 shadow-sm transition-all"
          />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 mb-8">
        <div className="bg-white dark:bg-[#0A0F1C] p-5 md:p-6 rounded-[20px] md:rounded-[24px] border border-slate-200 dark:border-slate-700 shadow-sm flex items-center justify-between group hover:shadow-md transition-all">
          <div>
        ...
        <div className="bg-white dark:bg-[#0A0F1C] p-5 md:p-6 rounded-[20px] md:rounded-[24px] border border-slate-200 dark:border-slate-700 shadow-sm flex items-center justify-between group hover:shadow-md transition-all sm:col-span-1">
          <div>
      ...
      <div className="bg-white dark:bg-[#0A0F1C] rounded-[20px] md:rounded-[24px] border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
        {filtered.length === 0 ? (
                            ...
                            <div className="flex items-center justify-end gap-3 max-w-xl ml-auto">
                              ...
                              <div className="relative flex-1">
                                <select 
                                  ...
                                  className="w-full appearance-none bg-white dark:bg-[#0A0F1C] border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2.5 text-sm font-bold outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 transition-all shadow-sm"
                                >
                              ...
                              <button 
                                ...
                                className="w-10 h-10 rounded-xl bg-white dark:bg-[#0A0F1C] border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-400 hover:text-slate-600 dark:hover:text-white transition-all shadow-sm"
                              >
                                <X size={18} />
                              </button>
                            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 p-4 md:p-6 lg:hidden bg-slate-50/50 dark:bg-slate-900/20">
              {filtered.map((g, idx) => (
                <motion.div 
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: idx * 0.05 }}
                  className="bg-white dark:bg-[#0A0F1C] rounded-2xl md:rounded-[20px] border border-slate-200 dark:border-slate-700 p-5 shadow-sm space-y-5"
                >
                                ...
                                {editingScheduleId === a.scheduleId ? (
                                  ...
                                  >
                                    <div className="relative">
                                      <select 
                                        ...
                                        className="w-full min-h-[44px] appearance-none bg-white dark:bg-[#0A0F1C] border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2.5 text-sm font-bold outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 transition-all shadow-sm"
                                      >
                                        <option value="">Select new guide...</option>
                                        {guidesList.filter(newG => newG._id !== g.guideId).map(newG => (
                                          <option key={newG._id} value={newG._id}>{newG.name}</option>
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      <button 
                                        onClick={() => setEditingScheduleId(null)}
                                        className="w-[44px] h-[44px] rounded-xl bg-white dark:bg-[#0A0F1C] border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-400 hover:text-slate-600 dark:hover:text-white transition-all shadow-sm"
                                      >
                                        <X size={18} />
                                      </button>
                                    </div>
                                  ...
                                  >
                                    <button 
                                      ...
                                      className="flex-1 min-h-[44px] flex items-center justify-center gap-2 rounded-xl bg-white dark:bg-[#0A0F1C] border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-bold text-xs hover:bg-slate-50 dark:hover:bg-slate-700 transition-all shadow-sm"
                                    >
