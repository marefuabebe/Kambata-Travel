...
export default function NotificationsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex items-center justify-between">
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="flex items-center gap-2 bg-white dark:bg-[#0A0F1C] border border-gray-200 dark:border-white/5 text-gray-700 dark:text-gray-300 px-5 py-3 rounded-2xl font-bold text-sm hover:bg-gray-50 dark:hover:bg-white/5 transition-all shadow-sm"
          >
            <CheckCheck size={18} />
            Mark All as Read
          </button>
      ...
      <div className="bg-white dark:bg-[#0A0F1C] rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-xl shadow-gray-200/40 dark:shadow-none overflow-hidden p-2">
