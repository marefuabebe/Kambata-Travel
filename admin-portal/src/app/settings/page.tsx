    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0F172A] text-slate-900 dark:text-[#F8FAFC] pb-24 md:pb-12 font-sans overflow-x-hidden">
      ...
      <div className="sticky top-0 z-40 bg-slate-50/90 dark:bg-[#0F172A]/90 backdrop-blur-md border-b border-slate-200 dark:border-[#334155] px-4 py-4 md:px-8">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          {/* Segmented Tabs */}
          <div className="flex bg-slate-100 dark:bg-[#1E293B] p-1.5 rounded-2xl border border-slate-200 dark:border-[#334155] shadow-inner relative w-full md:w-auto overflow-hidden">
            <button
              type="button"
        ...
        <AnimatePresence mode="wait">
          {activeTab === "profile" && (
            ...
            >
              ...
              {/* Profile Card */}
              <div className="bg-white dark:bg-[#1E293B] rounded-[24px] p-6 md:p-10 border border-slate-200 dark:border-[#334155] shadow-sm relative overflow-hidden">
          ...
          {activeTab === "system" && (
            ...
            >
              {/* ── Announcement Center ── */}
              <div className="lg:col-span-3 bg-white dark:bg-[#1E293B] rounded-[24px] p-6 md:p-10 border border-slate-200 dark:border-[#334155] shadow-sm flex flex-col relative overflow-hidden group">
                ...
                <form id="broadcast-form" onSubmit={handleBroadcast} className="space-y-6 flex-1 flex flex-col relative z-10">
                  ...
                  <div className="space-y-3 pt-2">
                    ...
                    <div className="flex bg-slate-100 dark:bg-[#0F172A] p-1.5 rounded-2xl border border-slate-200 dark:border-[#334155] shadow-inner relative w-full overflow-hidden">
                      ...
                      <motion.div
                        className={`absolute top-1.5 bottom-1.5 w-[calc(50%-6px)] bg-white dark:bg-[#1E293B] rounded-xl shadow border ${announcement.priority === 'HIGH' ? 'border-[#FF8C00]/30 shadow-[#FF8C00]/10' : 'border-slate-200 dark:border-slate-700'}`}
                        initial={false}
