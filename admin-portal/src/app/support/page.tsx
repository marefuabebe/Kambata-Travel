        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-4">
          ...
          <div className="relative w-full md:w-96">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-3 bg-white dark:bg-[#0A0F1C] border border-slate-200 dark:border-[#334155] rounded-2xl outline-none focus:border-[#FF8C00] dark:focus:border-[#FF8C00] text-sm shadow-sm transition-colors text-slate-900 dark:text-white placeholder:text-slate-400"
            />
          </div>
        </div>
      </div>
              ...
              {filteredTickets.map((ticket) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-white dark:bg-[#0A0F1C] rounded-2xl md:rounded-[20px] p-5 md:p-6 border border-slate-200 dark:border-[#334155] shadow-sm hover:shadow-md transition-shadow relative group"
                  >
      ...
      {selectedTicket && (
        <div className="fixed inset-0 z-[100] bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <motion.div 
            ...
            className="bg-white dark:bg-[#0A0F1C] rounded-[24px] p-6 md:p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-slate-200 dark:border-[#334155] shadow-xl"
          >
              ...
              <div className="bg-slate-50 dark:bg-[#0F172A] p-5 rounded-2xl border border-slate-200 dark:border-[#334155]">
                <div className="flex items-center justify-between mb-4 border-b border-slate-200 dark:border-[#334155] pb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-white dark:bg-[#0A0F1C] flex items-center justify-center shrink-0 border border-slate-200 dark:border-[#334155] text-slate-500 font-bold text-sm">
